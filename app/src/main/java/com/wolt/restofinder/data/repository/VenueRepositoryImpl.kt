...
class VenueRepositoryImpl
    ...
    constructor(
        ...
        override fun observeNearbyVenuesWithFavourites(
            latitude: Double,
            longitude: Double,
        ...
        private fun fetchVenues(
            ...
            val restaurantSection =
                response.sections.find { section ->
        ...
        override suspend fun toggleFavourite(venueId: String): Result<Unit> =
            try {
