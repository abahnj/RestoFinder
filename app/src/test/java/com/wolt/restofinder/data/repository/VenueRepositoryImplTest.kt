...
class VenueRepositoryImplTest {
    ...
    @Test
    fun `observeNearbyVenuesWithFavourites successfully fetches and merges`() =
        runTest {
    ...
    @Test
    fun `favourite toggle triggers re-emission without network refetch`() =
        runTest {
            val mockResponse = createMockResponse()
            coEvery { mockApi.getRestaurants(any(), any()) } returns mockResponse
    ...
    @Test
    fun `observeNearbyVenuesWithFavourites handles network errors`() =
        runTest {
    ...
    @Test
    fun `toggleFavourite delegates to DataStore`() =
        runTest {
    ...
    @Test
    fun `toggleFavourite handles errors`() =
        runTest {
    ...
    @Test
    fun `observeNearbyVenuesWithFavourites uses fallback section when named section not found`() =
        runTest {
            val mockResponse =
                WoltApiResponseDto(
                    sections =
    ...
    @Test
    fun `observeNearbyVenuesWithFavourites filters out items with null venue`() =
        runTest {
            val mockResponse =
                WoltApiResponseDto(
                    sections =
    ...
    private fun createMockResponse() =
        WoltApiResponseDto(
            sections =
                listOf(
                    // Categories section
                    SectionDto(name = "restaurants_page_categories", items = emptyList()),
                    SectionDto(
                        name = "restaurants-delivering-venues",
                        items =
                            listOf(
