...
class GetNearbyVenuesUseCaseTest {
    ...
    @Test
    fun `invoke limits venues to 15 maximum`() =
        runTest {
    ...
    @Test
    fun `invoke returns all venues when fewer than 15`() =
        runTest {
    ...
    @Test
    fun `invoke preserves venue order from repository`() =
        runTest {
            val venues =
                listOf(
                    createVenue("1"),
    ...
    @Test
    fun `invoke propagates errors from repository`() =
        runTest {
    ...
    private fun createVenue(id: String) =
        Venue(
            id = id,
            name = "Venue $id",
